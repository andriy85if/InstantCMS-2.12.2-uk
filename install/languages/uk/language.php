<?php
    ...
    define('LANG_PATHS_SESSION',            'Сесії');
    define('LANG_PATHS_SESSION_PATH',       'Директорія збереження сесій');
    define('LANG_PATHS_SESSIONS_BASEDIR',    'Повний шлях у файловій системі, який повинен входити в один із шляхів ');
    ...
    define('LANG_ADMIN_PASS_HASH_ERROR',    'Помилка створення хешу пароля, спробуйте ще раз');
    define('LANG_VALIDATE_MIN_LENGTH',      'Занадто коротке значення поля %s (мін. довжина: %s)');
    define('LANG_VALIDATE_MAX_LENGTH',      'Занадто довге значення поля %s (макс. довжина: %s)');

    define('LANG_CONFIG_INFO',              'Зараз буде створено файл конфігурації сайту.');
    define('LANG_CONFIG_PATH',              'Місце розташування файлу:');
    define('LANG_CONFIG_MUST_WRITABLE',     'Вказана директорія повинна бути доступною для запису.');
    define('LANG_CONFIG_AFTER',             'Після створення файла конфігурації необхідно буде зробити цю директорію (та файли, які в ній знаходяться) недоступними для запису.');
    define('LANG_CONFIG_NOT_WRITABLE',      'Директорія конфігурації не доступна для запису');
